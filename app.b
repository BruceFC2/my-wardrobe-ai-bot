...
# Configure your Gemini API Key safely from Streamlit Secrets
try:
...
st.set_page_config(page_title="AI Wardrobe Rotator", page_icon="shirt", layout="centered")
...
if st.button("Spin Wardrobe and Pick Outfit", type="primary"):
    if not occasion:
